...
#   sbatch scripts/030_SurvivalHeatmaps_job.sh surface_stokes 6000 step_wc0p1_ts3_tcinf
...
pixi run papermill --cwd notebooks/ \
    ...
    notebooks_executed/Visualisations/030_SurvivalHeatmaps_${regime}_r${hex_radius}m_${member}.ipynb \
