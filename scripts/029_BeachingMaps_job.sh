...
# One (regime, hex_radius, member, season) per submit; the notebook pools the
# season's monthly partitions across every release year. E.g.:
#   sbatch scripts/029_BeachingMaps_job.sh surface_stokes 6000 step_wc0p1_ts3_tcinf ALL
...
pixi run papermill --cwd notebooks/ \
    ...
    notebooks_executed/Visualisations/029_BeachingMaps_${regime}_r${hex_radius}m_${season}_${member}.ipynb \
